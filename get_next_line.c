...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/09/27 21:42:15 by jpopa-po          #+#    #+#             */
/*   Updated: 2021/09/27 21:42:52 by jpopa-po         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

char	*ft_readln(t_var *variable, char **line, int fd)
{
	while (variable->rd > 0)
	{
...
char	*ft_putnl(t_var *variable, char **line)
{
	variable->len = 0;
...
char	*ft_end(t_var *variable, char **line)
{
